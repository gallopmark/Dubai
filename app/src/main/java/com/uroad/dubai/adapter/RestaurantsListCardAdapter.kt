 ...
 * @author MFB
 * @create 2018/12/21
 * @describe Restaurants list adapter
 */
class RestaurantsListCardAdapter(context: Context, data: MutableList<NewsMDL>)
    ...
    override fun bindView(viewType: Int): Int = R.layout.item_restaurantslist_card
