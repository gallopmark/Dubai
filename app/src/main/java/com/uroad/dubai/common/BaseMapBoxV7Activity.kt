...
//
//abstract class BaseMapBoxV7Activity : BaseActivity(), PermissionsListener, LocationEngineCallback<LocationEngineResult> {
...
//            onLocation()
//        } else {
//            permissionsManager = PermissionsManager(this).apply { requestLocationPermissions(this@BaseMapBoxV7Activity) }
//        }
//    }
//
...
//                requestLocationUpdates(this, this@BaseMapBoxV7Activity, null)
//            }
//        }
