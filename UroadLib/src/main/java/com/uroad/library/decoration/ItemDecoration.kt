package com.uroad.library.decoration
 ...
 */
class ItemDecoration(context: Context, private val mOrientation: Int) : RecyclerView.ItemDecoration() {
    ...
    private var mDividerHeight = DisplayUtils.dip2px(context, 1f)//分割线高度，默认为1px
