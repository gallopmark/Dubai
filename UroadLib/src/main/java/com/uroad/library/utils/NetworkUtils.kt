...
class NetworkUtils {
    companion object {
        ...
        fun isAvailable(context: Context): Boolean {
            ...
            return info != null && info.detailedState ==  NetworkInfo.DetailedState.CONNECTED
        }
        ...
        fun is4G(context: Context): Boolean {
            val info = getActiveNetworkInfo(context)
            return info != null && info.detailedState ==  NetworkInfo.DetailedState.CONNECTED && info.subtype == TelephonyManager.NETWORK_TYPE_LTE
        }
